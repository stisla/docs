...
<a name="layout-other"></a>

## Other Layouts

For the other 2 layouts, you can get the following structure:
- [Transparent Sidebar](http://getstisla.com/pages/layout-transparent.html)
- [Top Navigation](http://getstisla.com/pages/layout-top-navigation.html)